...
public class FireStoreQueries {
    ...
    public void createCollectionWithDocument(String collectionName, String documentName){
    ...
    public void createCollectionWithDocumentAndElement(String collectionName, String documentName, String key, String value){
    ...
    public void createDocument(String collectionName, String documentName){
    ...
    public void createDocumentWithElement(String collectionName, String documentName, String key, String value){
    ...
    public void createElement(String collectionName, String documentName, String key, String value){
    ...
    public void createDocumentfromAMap(String collectionName, String documentName, HashMap<String,String> map){
    ...
    public String[] readCollection(String collectionName){
    ...
    public HashMap<String, String> readDocument(String collectionName, String documentName){
    ...
    public String readElement(String collectionName, String documentName, String key){
    ...
    public HashMap<String, String> readOneElementFromEachDocument(String collectionName, String key){
    ...
    public boolean existsDocument(String collectionName, String documentName){
    ...
    public boolean existsKey2(String collectionName, String documentName, String key){
    ...
    public boolean existsKey(String collectionName, String documentName, String key){
        HashMap<String, String> map =  new HashMap<>();
    ...
    //firebase. Use it in single operation and not in group exists() requests.
    //try to avoid using this method as much as possible.
    public boolean existsValue(String collectionName, String documentName, String value){
        HashMap<String, String> map =  new HashMap<>();
        HashMap<String, String> map2 =  new HashMap<>();
        HashMap<String, String> map3 =  new HashMap<>();
        map = readDocument(collectionName,documentName);
    ...
    public void updateDocument(String collectionName, String documentName){
    ...
    public void updateElement(String collectionName, String documentName, String key, String value){
    ...
    public void deleteElement(String collectionName, String documentName, String key){
    ...
    public HashMap<String, String> seedToMap(String seed){
        HashMap<String, String> map =  new HashMap<>();
    ...
    public String[] seedToArray(String seed){
        String[] arr = seed.split("@@");
        return arr;
    }

    public String mapToSeed(HashMap<String, String> map){
        String word = "";
